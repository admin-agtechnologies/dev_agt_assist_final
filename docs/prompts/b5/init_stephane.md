...
```
Bonjour, je suis Stéphane. Nous démarrons une session de test B5 sur AGT BOT.

**Session N° :** {numéro}
**Date :** {date}
**Objectif :** {description courte — ex: "catalogue_produits phases 1-3"}

Mes features B5 :
- catalogue_produits (9)
- suivi_commande (11)
- catalogue_trajets (12)
- reservation_billet (13)
- reservation_table (15)
...
3. Lis mes rapports de features existants dans docs/testing/features/stephane/
...
5. Rapport — Rédiger docs/testing/features/stephane/{feature_slug}.md
