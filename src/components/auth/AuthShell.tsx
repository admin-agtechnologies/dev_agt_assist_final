...
export function AuthLeftPanel({ locale }: { locale: "fr" | "en" }) {
  return (
    <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-[#075E54] text-white relative overflow-hidden">

      {/* L'IMAGE DE FOND : Remplacement de la zone verte par ton image */}
      <img
      ...
      {/* EFFET DE GRADIENT POUR LIER L'IMAGE AU DESIGN */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#075E54]/60 to-[#022c22]/90" />

      {/* LE RESTE DU CONTENU RESTE IDENTIQUE MAIS DÉPASSÉ PAR Z-10 */}
