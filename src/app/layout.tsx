...
// Favicon dynamique selon le secteur actif au moment du build/SSR
const SECTOR      = process.env.NEXT_PUBLIC_SECTOR ?? "hub";
const { favicon } = getLogoAssets(SECTOR);

export const metadata: Metadata = {
  metadataBase: new URL(BASE_URL),

  verification: {
    google: "UZCK3TigSzAARnarWGDqdAjGgHiaAAd2LBpPZx1BFWA",
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="fr" suppressHydrationWarning>
      <head>
        {/*
          Favicon injecté via <link> direct pour contourner le cache statique
          de Next.js sur export const metadata.icons.
          NEXT_PUBLIC_SECTOR est lu au build → chaque instance sectorielle
          reçoit son favicon.ico propre.
        */}
