// ============================================================
// FICHIER : src/app/_components/sector/hotel/HotelLandingContent.tsx
// Orchestrateur landing sectorielle hotel.
// Pattern identique à EcommerceLandingContent.tsx
// Couleurs : primary #1A3C5E, accent #C9A84C, bgFooter #0A1A2E
// ============================================================
"use client";
import Link from "next/link";
import { BedDouble, TrendingUp, Clock, Phone } from "lucide-react";
...
const ACCENT    = "#C9A84C";
const BG_FOOTER = "#0A1A2E";
const logo      = getLogoAssets("hotel");

const STATS = [
  { value: "+22%", labelKey: "stat1Label" as const, icon: TrendingUp },
  { value: "24/7", labelKey: "stat2Label" as const, icon: Clock },
  { value: "0",    labelKey: "stat3Label" as const, icon: Phone },
  { value: "5 min",labelKey: "stat4Label" as const, icon: BedDouble },
];

export default function HotelLandingContent() {
