// ============================================================
// FICHIER : src/app/_components/sector/pme/PmeLandingContent.tsx
// Orchestrateur landing sectorielle pme.
// Couleurs : primary #075E54, accent #10B981, bgFooter #022c22
// ============================================================
"use client";
import Link from "next/link";
import { TrendingUp, Clock, MessageCircle, Package } from "lucide-react";
...
import { PmeHero }              from "./PmeHero";
import { PmeFeatures }          from "./PmeFeatures";

const PRIMARY   = "#075E54";
const ACCENT    = "#10B981";
const BG_FOOTER = "#022c22";
const logo      = getLogoAssets("pme");

const STATS = [
  { value: "+40%", labelKey: "stat1Label" as const, icon: TrendingUp },
  { value: "24/7", labelKey: "stat2Label" as const, icon: Clock },
  { value: "0",    labelKey: "stat3Label" as const, icon: MessageCircle },
  { value: "5 min",labelKey: "stat4Label" as const, icon: Package },
];

export default function PmeLandingContent() {
        ...
        <div className="card p-12 text-center relative overflow-hidden border-0" style={ctaGradient}>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <Link href={`${ROUTES.onboarding}?sector=pme`} className="inline-flex items-center gap-2 px-8 py-3 rounded-xl font-black text-base transition-all hover:scale-105 shadow-lg" style={ctaBtnStyle}>{t.ctaBtn}</Link>
