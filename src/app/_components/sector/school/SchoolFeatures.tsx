// ============================================================
// FICHIER : src/app/_components/sector/school/SchoolFeatures.tsx
// Grille 6 features — landing sectorielle school.
// Couleurs : primary #3A0CA3, accent #6D28D9
// ============================================================
"use client";
import Link from "next/link";
import {
  GraduationCap, CalendarDays, Mail,
...
const ICONS = [GraduationCap, CalendarDays, Mail, BookOpen, MessageCircle, Building2];
      ...
      <div className="flex justify-center mt-10">
        ...
        >
          <p className="text-sm font-semibold text-[var(--text)]">
            {isFr
              ? "Vous n'êtes pas un établissement scolaire ?"
