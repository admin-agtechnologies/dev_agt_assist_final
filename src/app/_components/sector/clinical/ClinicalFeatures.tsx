// ============================================================
// FICHIER : src/app/_components/sector/clinical/ClinicalFeatures.tsx
// Grille 6 features — landing sectorielle clinical.
// Couleurs : primary #0077B6, accent #00B4D8
// Pattern identique à EcommerceFeatures.tsx
// ============================================================
"use client";
import {
  CalendarCheck, UserCheck, Bell,
  Stethoscope, Megaphone, FileText,
} from "lucide-react";
...
const FEATURES = [
  { icon: CalendarCheck, titleKey: "feature1Title" as const, descKey: "feature1Desc" as const },
  { icon: UserCheck,     titleKey: "feature2Title" as const, descKey: "feature2Desc" as const },
  { icon: Bell,          titleKey: "feature3Title" as const, descKey: "feature3Desc" as const },
  { icon: Stethoscope,   titleKey: "feature4Title" as const, descKey: "feature4Desc" as const },
  { icon: Megaphone,     titleKey: "feature5Title" as const, descKey: "feature5Desc" as const },
  { icon: FileText,      titleKey: "feature6Title" as const, descKey: "feature6Desc" as const },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mt-12">
          <a href="/" className="text-sm font-semibold transition-colors" style={{ color: PRIMARY }}>
            {"Votre activité n'est pas une clinique ? → Voir toutes les solutions →"}
          </a>
        </div>
      </div>
    </section>
