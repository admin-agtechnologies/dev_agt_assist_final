...
const STATUT_VARS: Record<string, { bg: string; text: string }> = {
  ouvert:          { bg: "var(--status-info-bg)",    text: "var(--status-info-text)"    },
  en_cours:        { bg: "var(--status-warning-bg)", text: "var(--status-warning-text)" },
  en_attente_docs: { bg: "var(--status-orange-bg)",  text: "var(--status-orange-text)"  },
  valide:          { bg: "var(--status-success-bg)", text: "var(--status-success-text)" },
  rejete:          { bg: "var(--status-danger-bg)",  text: "var(--status-danger-text)"  },
  clos:            { bg: "var(--status-neutral-bg)", text: "var(--status-neutral-text)" },
};
...
export function DossierResultCard({ item }: Props) {
  ...
  const statuses = d.dossiers.detail.statuses;
