...
const MODULE = getHubByPath("reservation-chambre")!;

export default function ReservationChambrePage() {
  ...
  useEffect(() => { load(); }, [load]);
  return <ModuleHubTemplate module={MODULE} items={items} total={total} loading={loading} onRefresh={load} />;
}