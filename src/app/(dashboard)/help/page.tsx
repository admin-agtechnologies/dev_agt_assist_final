...
// WhatsApp brand color — conservée intentionnellement (identité visuelle WA)
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* Chat support — couleur sectorielle */}
        <button
        ...
        {/* WhatsApp — couleur brand WA conservée */}
        <a
          href={whatsappUrl}
          target="_blank"
        ...
        >
          ...
          >
            <svg className="w-6 h-6" style={{ color: WA_GREEN }} viewBox="0 0 24 24" fill="currentColor">
