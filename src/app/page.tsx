...
import ClinicalLandingContent   from "./_components/sector/clinical/ClinicalLandingContent";
import PublicLandingContent    from "./_components/sector/public/PublicLandingContent";
import PmeLandingContent       from "./_components/sector/pme/PmeLandingContent";
...
const METADATA: Record<string, Metadata> = {
  hub: {
    ...
    description: "Créez votre assistant WhatsApp & vocal IA en 5 minutes. 10 secteurs couverts, sans code, 24h/24.",
  ...
  restaurant: {
    ...
    description: "Automatisez vos commandes WhatsApp, réservations de table et menu digital. Sans code, prêt en 5 minutes.",
  ...
  banking: {
    ...
    description: "Automatisez la prise de RDV, présentez vos produits financiers et gérez toutes vos agences. Sans code, prêt en 5 minutes.",
  ...
  school: {
    ...
    description: "Automatisez vos admissions, prises de RDV et la communication avec les parents. Sans code, prêt en 5 minutes.",
  ...
  ecommerce: {
    ...
    description: "Automatisez votre boutique : catalogue interactif, suivi commandes et relance panier. Sans code, prêt en 5 minutes.",
  ...
  hotel: {
    ...
    description: "Automatisez vos réservations chambre, disponibilités et services concierge. Sans code, prêt en 5 minutes.",
  ...
  transport: {
    ...
    description: "Vendez vos billets sur WhatsApp, gérez vos départs et notifiez vos voyageurs. Sans code, prêt en 5 minutes.",
  ...
  clinical: {
    title: "AGT-BOT Clinique — RDV Médicaux & Accueil Patient IA",
    description: "Automatisez vos prises de RDV médicaux, l'orientation patient et les rappels de consultation. Sans code, prêt en 5 minutes.",
    alternates: { canonical: "https://clinical.agt-bot.com" },
    openGraph: {
      url: "https://clinical.agt-bot.com",
      title: "AGT-BOT Clinique — RDV Médicaux & Accueil Patient IA",
      description: "Prise de RDV médicaux, orientation patient et rappels automatisés.",
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "AGT-BOT Clinique" }],
    },
  },
  public: {
    title: "AGT-BOT Secteur Public — Services Citoyens IA",
    description: "Modernisez l'accueil citoyen, gérez les demandes administratives et communiquez avec vos administrés. Sans code, prêt en 5 minutes.",
    alternates: { canonical: "https://public.agt-bot.com" },
    openGraph: {
      url: "https://public.agt-bot.com",
      title: "AGT-BOT Secteur Public — Services Citoyens IA",
      description: "Accueil citoyen, demandes administratives et communication institutionnelle automatisés.",
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "AGT-BOT Secteur Public" }],
    },
  },
  pme: {
    title: "AGT-BOT PME — Support Client & Conversion Prospects IA",
    description: "Automatisez votre support client, convertissez plus de prospects et fidélisez vos clients. Sans code, prêt en 5 minutes.",
    alternates: { canonical: "https://pme.agt-bot.com" },
    openGraph: {
      url: "https://pme.agt-bot.com",
      title: "AGT-BOT PME — Support Client & Conversion Prospects IA",
      description: "Support client 24/7, conversion de prospects et fidélisation automatisés.",
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "AGT-BOT PME" }],
    },
  },
};
...
function SectorPage() {
  switch (SECTOR) {
    ...
    case "clinical":   return <ClinicalLandingContent />;
    case "public":     return <PublicLandingContent />;
    case "pme":        return <PmeLandingContent />;
    case "hub":
