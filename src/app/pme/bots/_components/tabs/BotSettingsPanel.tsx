...
import { Settings, MessageSquare, Phone, Globe, Activity, AlertCircle, Save } from "lucide-react";
...
export function BotSettingsPanel({ pair, d, colors, onRefresh }: BotSettingsPanelProps) {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await botsRepository.patch(pair.waBot.id, { nom: waDisplayName || mainName });
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/10">
                ...
                <span className={cn("text-xs font-bold", pair.voiceBot ? "text-sky-300" : "text-white/40")}>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">
                Si vous souhaitez changer de numéro ou modifier les capacités profondes de l&apos;IA,
                veuillez contacter votre conseiller AGT.
              </p>
            </div>
          </div>
        </div>
